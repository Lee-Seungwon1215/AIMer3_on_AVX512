...
```bash
make -C x86 kat PARAM=128f
```

지원 CPU에서 backend 강제 선택:

```bash
AIMER_V3_IMPL=ref    x86/build/liboqs/tests/test_oqs_sig_registry
AIMER_V3_IMPL=avx2   x86/build/liboqs/tests/test_oqs_sig_registry
AIMER_V3_IMPL=avx512 x86/build/liboqs/tests/test_oqs_sig_registry
```
