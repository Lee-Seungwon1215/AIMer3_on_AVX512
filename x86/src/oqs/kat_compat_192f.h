...
// Adapts the official 192f PQCgenKAT_sign driver to the detached OQS_SIG API.

#ifndef AIMER_V3_OQS_KAT_COMPAT_192F_H
#define AIMER_V3_OQS_KAT_COMPAT_192F_H
...
#define CRYPTO_PUBLICKEYBYTES OQS_SIG_aimer_v3_192f_length_public_key
#define CRYPTO_SECRETKEYBYTES OQS_SIG_aimer_v3_192f_length_secret_key
#define CRYPTO_BYTES OQS_SIG_aimer_v3_192f_length_signature
#ifndef CRYPTO_ALGNAME
#define CRYPTO_ALGNAME "aimer-192f"
#endif
...
static OQS_SIG *oqs_kat_sig(void) {
	...
	if (sig == NULL) {
		OQS_init();
		sig = OQS_SIG_new(OQS_SIG_alg_aimer_v3_192f);
	}
	return sig;
}
...
#endif // AIMER_V3_OQS_KAT_COMPAT_192F_H
