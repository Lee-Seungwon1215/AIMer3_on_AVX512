...
{
  aimer_v3_avx2_shake128x4incctx ctx;
  ...
  aimer_v3_avx2_shake128_x4_inc_init(&ctx);
  ...
  aimer_v3_avx2_shake128_x4_inc_finalize(&ctx);
  ...
  aimer_v3_avx2_shake128_x4_inc_squeeze(
      ...
      sizeof(tape_t), &ctx);
  aimer_v3_avx2_shake128_x4_inc_ctx_release(&ctx);
}
