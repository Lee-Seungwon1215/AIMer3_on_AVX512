...
OQS_API const char *OQS_SIG_alg_identifier(size_t i) {
	static const char *algorithms[OQS_SIG_algs_length] = {
		...
		OQS_SIG_alg_aimer_v3_128s,
		OQS_SIG_alg_aimer_v3_192f,
		OQS_SIG_alg_aimer_v3_192s,
		OQS_SIG_alg_aimer_v3_256f,
		OQS_SIG_alg_aimer_v3_256s,
	};
...
OQS_API int OQS_SIG_alg_is_enabled(const char *method_name) {
	return method_name != NULL &&
	       (strcasecmp(method_name, OQS_SIG_alg_aimer_v3_128f) == 0 ||
	        strcasecmp(method_name, OQS_SIG_alg_aimer_v3_128s) == 0 ||
	        strcasecmp(method_name, OQS_SIG_alg_aimer_v3_192f) == 0 ||
	        strcasecmp(method_name, OQS_SIG_alg_aimer_v3_192s) == 0 ||
	        strcasecmp(method_name, OQS_SIG_alg_aimer_v3_256f) == 0 ||
	        strcasecmp(method_name, OQS_SIG_alg_aimer_v3_256s) == 0);
}
...
OQS_API OQS_SIG *OQS_SIG_new(const char *method_name) {
	...
	if (strcasecmp(method_name, OQS_SIG_alg_aimer_v3_128f) == 0) {
		return OQS_SIG_aimer_v3_128f_new();
	}
	if (strcasecmp(method_name, OQS_SIG_alg_aimer_v3_128s) == 0) {
		return OQS_SIG_aimer_v3_128s_new();
	}
	if (strcasecmp(method_name, OQS_SIG_alg_aimer_v3_192f) == 0) {
		return OQS_SIG_aimer_v3_192f_new();
	}
	if (strcasecmp(method_name, OQS_SIG_alg_aimer_v3_192s) == 0) {
		return OQS_SIG_aimer_v3_192s_new();
	}
	if (strcasecmp(method_name, OQS_SIG_alg_aimer_v3_256f) == 0) {
		return OQS_SIG_aimer_v3_256f_new();
	}
	if (strcasecmp(method_name, OQS_SIG_alg_aimer_v3_256s) == 0) {
		return OQS_SIG_aimer_v3_256s_new();
	}
	return NULL;
}
