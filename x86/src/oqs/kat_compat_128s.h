...
// Adapts the official 128s PQCgenKAT_sign driver to the detached OQS_SIG API.

#ifndef AIMER_V3_OQS_KAT_COMPAT_128S_H
#define AIMER_V3_OQS_KAT_COMPAT_128S_H
...
#define CRYPTO_PUBLICKEYBYTES OQS_SIG_aimer_v3_128s_length_public_key
#define CRYPTO_SECRETKEYBYTES OQS_SIG_aimer_v3_128s_length_secret_key
#define CRYPTO_BYTES OQS_SIG_aimer_v3_128s_length_signature
#define CRYPTO_ALGNAME "aimer-128s"

static OQS_SIG *oqs_kat_sig(void) {
	static OQS_SIG *sig;
	if (sig == NULL) {
		OQS_init();
		sig = OQS_SIG_new(OQS_SIG_alg_aimer_v3_128s);
	}
	return sig;
}
...
#endif // AIMER_V3_OQS_KAT_COMPAT_128S_H
