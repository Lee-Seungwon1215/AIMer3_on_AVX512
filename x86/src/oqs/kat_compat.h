...
// Adapts the official PQCgenKAT_sign driver to the detached OQS_SIG API.

#ifndef AIMER_V3_OQS_KAT_COMPAT_H
#define AIMER_V3_OQS_KAT_COMPAT_H

/* Prevent the driver from importing the standalone RNG and direct API. */
#define rng_h
#define API_H
...
#define CRYPTO_PUBLICKEYBYTES OQS_SIG_aimer_v3_128f_length_public_key
#define CRYPTO_SECRETKEYBYTES OQS_SIG_aimer_v3_128f_length_secret_key
#define CRYPTO_BYTES OQS_SIG_aimer_v3_128f_length_signature
#define CRYPTO_ALGNAME "aimer-128f"

static OQS_SIG *oqs_kat_sig(void) {
	static OQS_SIG *sig;
	if (sig == NULL) {
		OQS_init();
		sig = OQS_SIG_new(OQS_SIG_alg_aimer_v3_128f);
	}
	return sig;
}
...
#endif // AIMER_V3_OQS_KAT_COMPAT_H
