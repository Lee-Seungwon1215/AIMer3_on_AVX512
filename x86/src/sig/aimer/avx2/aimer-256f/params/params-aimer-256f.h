...
#define AIMER_NAMESPACE(s)          samsungsds_aimer_256f_avx2_##s
...
#define AIM3_NUM_INPUT_SBOX         3                    // number of AIM3 input S-boxes
...
#define AIMER_SIG_BYTES             31360                // byte size of signature
