...
typedef enum {
  ...
  /** Used to indicate that an invalid algorithm name was provided. */
  OQS_ERROR_INVALID_ALGORITHM = 10,
  /** Used to indicate that an invalid public key was provided. */
  OQS_ERROR_INVALID_PUBKEY = 11,
  /** Used to indicate that an invalid secret key was provided. */
  OQS_ERROR_INVALID_SECRETKEY = 12,
  /** Used to indicate memory allocation failure. */
  OQS_ERROR_MEMORY_ALLOC = 13,

  /** Used to indicate that an invalid kem was provided. */
  OQS_ERROR_INVALID_OQSKEM = 20,

  /** Used to indicate that an invalid ciphertext was provided. */
  OQS_ERROR_INVALID_CIPHERTEXT = 21,
  /** Used to indicate that an invalid shared secret was provided. */
  OQS_ERROR_INVALID_SHAREDSECRET = 22,
  /** Used to indicate that an invalid seed was provided. */
  OQS_ERROR_INVALID_SEED = 23,

  /** Used to indicate that an invalid signature was provided. */
  OQS_ERROR_INVALID_OQSSIG = 30,

  /** Used to indicate that an invalid message was provided. */
  OQS_ERROR_INVALID_MESSAGE = 31,
  /** Used to indicate that an invalid signature was provided. */
  OQS_ERROR_INVALID_SIGNATURE = 32,

  OQS_ERROR_JNI_EXCEPTION = 40,
...
/**
 * Securely free memory allocated with OQS_MEM_aligned_alloc.
 *
 * This function first cleanses the memory by overwriting it with zeros
 * before freeing it.
 */
